...
--   NEW in 2.4: Drum patterns now use a re-mappable 'M.drum_map' table instead of hard-coded MIDI notes.
...
-------------------------------------------
-- 5. DRUM PATTERN LIBRARY (UPDATED v2.4)
-------------------------------------------
