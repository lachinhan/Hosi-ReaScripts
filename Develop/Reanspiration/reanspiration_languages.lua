...
-- @version 2.3 (Drum Map UI Update)
-- @author Hosi
-- @about
...
languages['en'] = {
  ...
  arranger_structure_title = "Song Structure",
...
languages['vi'] = {
  ...
  arranger_structure_title = "Cấu Trúc Bài Hát",
  ...
  error_no_item_selected_for_action = "Lỗi: Chưa chọn item MIDI. Vui lòng chọn một item trước khi thực hiện hành động '%s'.",
...
languages['ja'] = {
  ...
  -- NEW: Drum Map Section (v2.3) - Placeholder
  drum_map_section_title = "Drum Map Editor",
  drum_map_info_text = "Edit the MIDI note for each drum part (0-127).",
  drum_map_BassDrum = "Bass Drum",
  drum_map_SnareStick = "Snare Stick",
...
languages['zh'] = {
  ...
  error_item_not_midi_for_action = "错误：所选项目不是MIDI。请为“%s”操作选择一个有效的MIDI项目。",
}
